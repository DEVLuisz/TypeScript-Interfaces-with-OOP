...
import { NegociacoeServices } from '../services/negociacoes-services.js';
import { imprimirLog } from '../utils/imprimir.js';
...
export class NegociacaoController {
    ...
    private negociacaoService = new NegociacoeServices();
    ...
    public adiciona(): void {
        ...
        imprimirLog(negociacao, this.negociacoes);
